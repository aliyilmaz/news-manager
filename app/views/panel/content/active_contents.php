...
<head>
    ...
    <title>Active contents | News Manager</title>
</head>
...
<body>
    ...
    <div class="m-4">
        ...
        <br>
        <?php $contents = $this->samantha('contents', ['status'=>1]); ?>
        <?php  foreach ($contents as $key => $content) { ?>
            <div class="alert alert-success rounded-0 border-0" role="alert">
                <h6>
                    <?=$content['title'];?><br>
                    <small>It will be discontinued after <em><strong><?=$this->timeAgo($content['end_date'], ['a'=>'', 'f'=>true]);?></strong></em></small>
                </h6>
